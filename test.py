...
def main():
    ...
    # get test fnames
    all_fnames = sorted(getFiles(mask_dir))
    training_set = [f'Case_0000{i}.npy' for i in range(1,10)]
    training_set += [f'Case_000{i}.npy' for i in range(10,51)]
    test_fnames = list(filter(lambda fname: fname not in training_set, all_fnames))
