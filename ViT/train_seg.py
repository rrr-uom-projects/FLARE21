...
def main():
    ...
    train_dataset = customDataset(img_dir, mask_dir, train_transforms, indices=train_idx)
    test_dataset = customDataset(img_dir, mask_dir, test_transforms, indices=val_idx)
