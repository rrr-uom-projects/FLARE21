...
from model_parts import conv_module, resize_conv, bottleneck_module, asym_conv_module, asym_resize_conv, asym_bottleneck_module, bridge_module
...
# increases parameters from 8,319,207 -> 9,482,151
